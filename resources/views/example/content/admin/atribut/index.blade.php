                ...
                <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500">Attributes</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="px-4 pt-6">
        ...
        <div class="mb-4 flex justify-between items-center">
            {{-- <form class="flex items-center space-x-2" action="#" method="GET">
                <label for="attribute-search" class="sr-only">Search</label>
                <input type="text" name="search" id="attribute-search"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Search for attributes">
            </form> --}}

            <a href="{{ Route('atribut.tambah') }}"
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @php($no = 1)
                    @forelse ($productatributs as $row)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="p-4 space-x-2 whitespace-nowrap">
                                <a href="{{ route('atribut.edit', $row->id) }}">
                                ...
                                <form action="{{ route('atribut.hapus', $row->id) }}" method="POST"
