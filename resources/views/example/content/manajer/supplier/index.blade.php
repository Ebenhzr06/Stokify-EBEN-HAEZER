                ...
                <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500">Suppliers</span>
                        </div>
                    </li>
            </ol>
            </nav>
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Daftar Semua Supplier</h1>
        </div>
    </div>
    ...
    <div class="px-4 pt-6">
        ...
        {{-- <div class="mb-4 flex justify-between items-center">
            <form class="flex items-center space-x-2" action="#" method="GET">
                ...
                <input type="text" name="search" id="supplier-search"
                    ...
                    @forelse ($supplier as $row)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            {{-- <td class="p-4 space-x-2 whitespace-nowrap">
                                ...
                                <form action="{{ route('supplier.hapus', $row->id) }}" method="POST"
