    ...
    <div
        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Produk Manajemen</span>
                ...
                {{ Request::is('/products') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                                    Produk
                                </a>
                            </li>

                            {{-- <li>
                                <a href="{{ route('crud.users') }}"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('example/crud/users') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                            ...
                            <li>
                                <a href="{{ route('Admin.category.index') }}"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('example/category/index') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                                    Kategori
                                </a>
                            </li>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('Admin.atribut.index') }}"
                            class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('example/atribut/index') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                            Produk Atribut
                        </a>
                    </li>
                </ul>
                ...
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Stok Manajemen</span>
                        <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                    ...
                    <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ route('Admin.stock.index') }}"
                                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Transaction</a>
                        </li>
                        <li>
                            <a href="{{ route('Admin.opname.index') }}"
                                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Stock Opname</a>
                        </li>
                        {{-- <li>
                            <a href="{{ route('stock.pengaturan') }}"
                                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Setting Min Product</a>
                        </li> --}}
                    </ul>
                </li>
                    ...
                    <ul id="dropdown-auth" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ route('Admin.laporan.stock') }}"
                                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Laporan Stok Barang</a>
                        </li>
                        <li>
                            <a href="{{ route('Admin.laporan.transaksi') }}"
                                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Laporan Transaksi</a>
                        </li>
                        <li>
                            <a href="{{ route('Admin.laporan.user') }}"
                                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Laporan Aktif User</a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800"
            ...
            <a href="{{ url('example/settings/') }}" data-tooltip-target="tooltip-settings"
                class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
